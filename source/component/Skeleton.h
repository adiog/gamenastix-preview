...
struct Skeleton
{
            ...
            : pelvis(bio::Segment::Pelvis, 0.3F, 0.5F)
    {
        ...
        insertBone(bones, bio::Segment::FootLeft, 0.20F, 0.3F);
        ...
        insertBone(bones, bio::Segment::FootRight, 0.20F, 0.3F);
    ...
    Bone pelvis;
    BoneSequence spine;
    std::unordered_map<bio::Segment, Bone, EnumClassHash> bones;
    std::unordered_map<bio::Sequence, BoneSequence, EnumClassHash> limbs;
};
}
